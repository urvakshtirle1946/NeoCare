      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
              ...
              {trustBadge.icons && (
                <div className="flex gap-1">
                  {trustBadge.icons.map((icon, index) => (
                    <span 
                      key={index} 
                      className={index === 0 ? 'text-yellow-300' : index === 1 ? 'text-orange-300' : 'text-amber-300'}
                    >
                      {icon}
                    </span>
                  ))}
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-normal tracking-tight text-white animate-fade-in-up animation-delay-200" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-normal tracking-tight text-white animate-fade-in-up animation-delay-400" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
              {headline.line2}
            </h1>
          </div>
          ...
          <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
            <p className="text-base md:text-lg lg:text-xl text-white/85 font-light leading-relaxed" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
              {subtitle}
            </p>
          </div>
