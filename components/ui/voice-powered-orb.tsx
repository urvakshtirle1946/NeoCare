...
export const VoicePoweredOrb: FC<VoicePoweredOrbProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // glContext.canvas may be HTMLCanvasElement or OffscreenCanvas; cast for DOM ops
      const canvasEl = glContext.canvas as unknown as HTMLCanvasElement;
      container.appendChild(canvasEl);

      // OGL expects a WebGL2-like context; cast to any to satisfy typings
      const oglCtx: any = glContext as any;
      const geometry = new Triangle(oglCtx);
      program = new Program(oglCtx, {
        vertex: vert,
        fragment: frag,
        uniforms: {
          iTime: { value: 0 },
      ...
      const mesh = new Mesh(oglCtx, { geometry, program });
